...
🔷 [Financial Data Pipeline — AWS Glue, S3, Snowflake, Airflow](https://github.com/RohithYtech77/financial-data-pipeline-aws)

🔷 [Legacy ETL Migration — Snowflake + dbt + Great Expectations](https://github.com/RohithYtech77/etl-migration-snowflake-dbt)

🔷 [ML-Ready Data Pipeline — PySpark, AWS, Snowflake](https://github.com/RohithYtech77/ml-data-pipeline-pyspark)
